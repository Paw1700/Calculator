...
export class CalculatorService implements OnDestroy {
    public screen = new BehaviorSubject<string>('0');

    // private choosedAction = '';
    ...
    private showVar() {
        console.log("Move Table: " + this.moveTable);
        console.log("newTypedNumber Bool: " + this.newTypedNumber);
        console.log('gottenResult Bool: ' + this.gottenResult);
        console.log('openBracket Bool: ' + this.openBracket);
        console.log('addMultiplyAfterBracket Bool: ' + this.addMultiplyAfterBracket);
        console.log("_________________________________________");
    }

    public buttonClicked(move: string): void {
        switch (move) {
            case '1':
            case '2':
            case '3':
    ...
    public resetCalculator() { // USED IN AC AND AFTER EXITING CALCULATOR
        this.newTypedNumber = true;
        this.gottenResult = true;
        this.openBracket = false;
        this.addMultiplyAfterBracket = false;
